...
globalThis.CKE = ck;
globalThis.CKE.StrapiMediaLib = StrapiMediaLib;
globalThis.CKE.StrapiUploadAdapter = StrapiUploadAdapter;
...
export const toolbarBalloonEditorConfig = {
  plugins: [...basePlugins, CKE.BalloonToolbar],
  ...base,
  toolbar: [
    {
      label: " ",
